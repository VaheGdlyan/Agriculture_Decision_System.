...
![Model Comparison Showdown](assets/model_comparison_showdown.png)
...
![Statistical Synthesis Dashboard](assets/pro_error_synthesis.png)
...
![Spatial and Size Error Analysis](assets/spatial_size_error_analysis.png)
...
![Hardest Case — OOD Failure (56 combined errors, conf=0.44)](assets/hardest_case_ood.png)
